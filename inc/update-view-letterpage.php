	...
	<form action="" method="POST" id="step3form" widget-next="step4wrap" form-next="step4form" form-target="step3form">
		...
		<div class="form-group form-group2">
			...
			<div class="col-sm-9">
				...
				<input ng-click="loadreadymadecontent();" class="step3radio" type="radio" required name="<?php echo PREMETA; ?>printing_type" <?php checked_radio(get_pdfnewsletter_meta($pid,PREMETA.'printing_type'),"0.00"); ?> value="0.00"> Black & White (£0.00) &nbsp;&nbsp;
				<input ng-click="loadreadymadecontent();" class="step3radio" type="radio" required name="<?php echo PREMETA; ?>printing_type" <?php checked_radio(get_pdfnewsletter_meta($pid,PREMETA.'printing_type'),"0.20"); ?> value="0.20"> Full Colour (£0.20)
			</div>
			<div class="clearfix"></div>
		</div>
		<div class="clearfix"></div>
		<div class="form-group form-group2">
			...
			<div class="col-sm-9">
				...
				<span ng-repeat="x in deliveryType" ng-if=" x.name != '' ">

					<input ng-click="loadreadymadecontent();" class="step3radio"  type="radio" required name="<?php echo PREMETA; ?>delivery_type" ng-model="$parent.deliverytypechecked" value="{{ x.cost  }}">{{x.name}} (£{{ x.cost   }}) &nbsp;&nbsp;												
				</span>				
		...
		<div class="form-group form-group2">
			...
			<div class="col-sm-9">
				...
				<span ng-repeat="x in deliveryClass" >

					<input ng-click="loadreadymadecontent();" class="step3radio"  type="radio" required name="<?php echo PREMETA; ?>delivery_class" ng-model="$parent.deliverychecked" value="{{ x.cost  }}">{{x.name}} (£{{ x.cost   }}) &nbsp;&nbsp;												
				</span>
		...
		<div class="form-group form-group2">
			...
			<div class="col-sm-9">
				...
				<input ng-click="loadreadymadecontent();" class="step3radio" type="radio" required name="<?php echo PREMETA; ?>accompanying_letter" <?php checked_radio(get_pdfnewsletter_meta($pid,PREMETA.'accompanying_letter'),"0.15"); ?> value="0.15">Yes (£0.15) &nbsp;&nbsp;
				<input ng-click="loadreadymadecontent();" class="step3radio" type="radio" required name="<?php echo PREMETA; ?>accompanying_letter" <?php checked_radio(get_pdfnewsletter_meta($pid,PREMETA.'accompanying_letter'),"0.00"); ?> value="0.00">No (£0.00)
			</div>
			<div class="clearfix"></div>
		</div>
		<div class="clearfix"></div>
		<div class="form-group form-group2">
			...
			<div class="col-sm-9">
				...
				<input ng-click="loadreadymadecontent();" class="step3radio" type="radio" required name="<?php echo PREMETA; ?>promotional_leaflets" <?php checked_radio(get_pdfnewsletter_meta($pid,PREMETA.'promotional_leaflets'),"0.20"); ?> value="0.20">Yes (£0.20 Discount)&nbsp;&nbsp;
				<input ng-click="loadreadymadecontent();" class="step3radio" type="radio" required name="<?php echo PREMETA; ?>promotional_leaflets" <?php checked_radio(get_pdfnewsletter_meta($pid,PREMETA.'promotional_leaflets'),"0.00"); ?> value="0.00">No (£0.00)
			</div>
			<div class="clearfix"></div>
		</div><br /><br />
	...
	<form action="" method="POST" id="step4form"  form-target="step4form" ng-submit="step4msubmit()">
		...
		<div class="form-group">
			<div class="col-sm-6">
				...
				<input class="print_post_date" checked type="radio" required name="<?php echo PREMETA; ?>print_post_date" <?php checked_radio(get_pdfnewsletter_meta($pid,PREMETA.'print_post_date'),"ASAP"); ?> value="ASAP">ASAP &nbsp;&nbsp;
